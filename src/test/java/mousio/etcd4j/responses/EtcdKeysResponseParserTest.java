...
public class EtcdKeysResponseParserTest {
  ...
  public void testParseSetKeyTtl() throws Exception {
    ...
    assertEquals(DateTime.parse("2013-12-04T12:01:21.874888581-08:00"), action.node.expiration);
  }
  ...
  public void testParseUpdateKeyTtl() throws Exception {
    ...
    assertEquals(DateTime.parse("2013-12-04T12:01:21.874888581-08:00"), action.prevNode.expiration);
  }
  ...
  public void testParseExpiredDir() throws Exception {
    ...
    assertEquals(DateTime.parse("2013-12-11T10:39:35.689275857-08:00"), action.prevNode.expiration);
